...
$$
\alpha_0 + \alpha_1 \cdot m_{bp} + \alpha_2 \cdot r + f_{ctrl\_init} \cdot \alpha_5 \cdot \sum_{b=0}^6(b_i \cdot 2^i) + \sum_{i=0}^7 (\alpha_{i+8} \cdot v_i)
$$
